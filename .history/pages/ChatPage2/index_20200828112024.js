...
const ChatPage2 = ({ }) => {
    ...
    const [transtext, setTranstext] = useState(type_text);
    ...
    >
        ...
        <div id="buttons">
            <CB2 text="Submit" onClick={() =>{
                setText("Reset"), setColor("coral"), setTranstext(type_text)
            }}/>
            <CB2 text={text} color={color} onClick={() => {
                setText("Reset!"), setColor("blue")
            }
            }
            />
        </div>
