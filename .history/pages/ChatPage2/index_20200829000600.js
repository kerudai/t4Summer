...
const ChatPage2 = ({}) => {
    ...
    const [rsp, setRsp] = useState("Let me respond to you!");
    ...
    >
        ...
        <div id="chats">
            ...
            <p></p>
            <C2 name="Chatbot" text={rsp} img={"https://d15shllkswkct0.cloudfront.net/wp-content/blogs.dir/1/files/2018/01/robot-2192617_960_720.png"} />
        </div>
        <div id="input">
            <I2 onClick={(val)=>{
                setMsg(val);
