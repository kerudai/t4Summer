...
const ChatPage = ({ }) => {
    ...
    useEffect(()=>{
        setTimeout(()=>{
            document.querySelector("#chatpage1").style.left = 0;
        }, 50);
    }, []);

    return <div id="chatpage1">
        <div id="welcome">
        ...
        <div id="reset">
            ...
            <div id="custom_button" onClick={
                () => {
                    setColor("blue"); setText("Reset!"); setWelcome("Welcome to my app!"); setMsg("Pls type sth!"); setResp("Let me respond to you.");
                }}>
